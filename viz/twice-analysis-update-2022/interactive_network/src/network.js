...
function network(songFile) {
    ...
    var songFiles = ["ALL_SONGS.csv","LikeOohAhh.csv","CheerUp.csv","TT.csv",
        ...
        "ICantStopMe.csv","CryForMe.csv","AlcoholFree.csv", "Scientist.csv","TalkThatTalk.csv"]


    var songNames = ["ALL SONGS (2015-2022)","Like Ooh Ahh (2015)","Cheer Up (2016)",
        ...
        "Scientist (2022) ","Talk That Talk (2022) "]
    ...
    function createNetwork(links) {
        ...
        song_desc_div.html(function (d) {
            return (songName == "ALL SONGS (2015-2022)")?
                "<br/>The ALL SONGS network represents the top 30% most-frequently occurring line succession pairs\
                 in TWICE's Korean title tracks from 2015-2022. This is the network that serves as the most basic \"recipe\" that defines a TWICE song."
                  :
